...
The Coupling Intensity Index introduced here is a statistically significant predictor of Amihud illiquidity under two-way clustered inference ($t = 2.90$, $p = 0.004$). The signal survives a horse race against nine standard liquidity predictors and remains significant under the wild cluster restricted bootstrap appropriate at $G = 50$ firms ($p = 0.018$); the Bell--McCaffrey CR2 adjustment is borderline ($p = 0.066$), reflecting the conservatism of the Satterthwaite reference distribution at this sample size. CII does not, however, predict realised volatility once cross-sectional and temporal dependence are properly accounted for (two-way clustered $t = 0.84$, $p = 0.40$); the volatility null is sharp under the small-sample corrections as well. The coupling signals liquidity regime deterioration, not volatility per se.
